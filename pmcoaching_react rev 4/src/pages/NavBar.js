   ...
   <div>
     <Navbar color="faded" light>
       ...
       <Collapse isOpen={!collapsed} navbar>
         <Nav navbar>
           <NavItem>
             <NavLink style={{color: "#9D7E68", fontSize: "18px", fontWeight: "bold", fontFamily: "Permanent Marker, cursive"}}  href="/projects">Project Management</NavLink>
           {/* <Leadcourses/> */}
           </NavItem>
           <NavItem>
             <NavLink style={{color: "#9D7E68", fontSize: "18px", fontWeight: "bold", fontFamily: "Permanent Marker, cursive"}} href="/leaderships">Leadership Courses</NavLink>
           </NavItem>
           <NavItem>
           ...
           <NavItem>
             <NavLink style={{backgroundColor: "#9D7E68", color: "white", width: "100px", border: "none", padding: "10px", textAlign: "center", fontSize: "18px", fontWeight: "bold", fontFamily: "Permanent Marker, cursive"}} href="/profile"> Profile</NavLink>
           </NavItem>
         </Nav>
       </Collapse>
     </Navbar>
